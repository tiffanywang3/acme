...
describe('Cart model', function () {
    ...
    it('should exist', function () {
        ...
        describe('getHistory should get all carts whose status !== active', function (){
            it('should get 2 carts with non-active status', function (done) {
                 Cart.create([{user_id: userId, status: "active", items: [{product: productId, quantity: 2}]}, {user_id: userId, status: "ordered", items: [{product: productId, quantity: 1}]}, {user_id: userId, status: "shipped", items: [{product: productId, quantity: 3}]}])
                 .then(function(carts){
                    return Cart.getHistory(createdUser)                
                    })
                .then(function (carts) {
